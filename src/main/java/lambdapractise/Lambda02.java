...
public class Lambda02 {
    public static void main(String[] args) {
        ...
        elementsBasinaSonunaYildiz(meyve);
        System.out.println("\n *********");

        karakterSayisinaGoreBuyKucSirIlk3(meyve);
    ...
    public static void elementsBasinaSonunaYildiz(List<String> meyve){
    ...
    public static void karakterSayisinaGoreBuyKucSirIlk3(List<String> meyve){
       List<String> sonuc =  meyve.
                stream().
                sorted(Comparator.comparing(String::length).reversed()).limit(3).
