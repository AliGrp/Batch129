...
public class Pangram {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isPangram("The quick brown fox jumps over the lazy dog.Pijamalı hasta yağız şoföre çabucak güvendi"));

        System.out.println(isPangram2("The quick brown fox jumps over the lazy dog.Pijamalı hasta yağız şoföre çabucak güvendi"));
    }
