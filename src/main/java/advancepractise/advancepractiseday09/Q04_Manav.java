    ...
    */
    ...
    public static void musteriSeccimi() {
        ...
        System.out.println(kilo + " kilo " + urunlistesi.get(kod - 1).substring(0, urunlistesi.get(kod - 1).indexOf(" ")) + ": "
                + Double.parseDouble(urunlistesi.get(kod - 1).substring(urunlistesi.get(kod - 1).lastIndexOf(" ") )) * kilo);
        toplamOdeme += Double.parseDouble(urunlistesi.get(kod - 1).substring(urunlistesi.get(kod - 1).lastIndexOf(" ") )) * kilo;
        System.out.println("toplamOdeme = " + toplamOdeme);
