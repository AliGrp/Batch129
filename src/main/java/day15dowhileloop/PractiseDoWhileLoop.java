...
public class PractiseDoWhileLoop {
...
*/
        ...
        if (str.contains("a")&&str.contains("c")){
            ...
            System.out.println("c den önceki 'a' karakterinin sayısı "+sayaç);


        }else {
            System.out.println("Lütfen 'a' ve 'c' karakterleri içeren bir kelime giriniz ");
        }
    }
}
