...
import exercise.proje.Arac;
import exercise.proje.AracTalebi;
...
public class MusteriVeAracBilgileriServis {
    ...
    public static void musteriBilgileri() {
        ...
        String yas;
        do {
            System.out.println("Lutfen 11 haneli TC no giriniz:");
            tcNo = inp.next();
            if (tcNo.length() == 11) {

            } else {
                System.out.println("Eksik veya hatali tuslama yaptiniz");
            }


            System.out.println(" Yaşınız:");
            yas = inp.next();
            if (Integer.valueOf(yas) <= 18 || Integer.valueOf(yas) >= 65) {
                System.out.println("18 yasindan kucuk ve 65 yasindan buyuklere arac verememekteyiz");
    ...
    public static void OdemeBilgieri() {
        ...
        do {
            ...
            if (kartNo.replaceAll(" ", "").length() == 12)
                break;
