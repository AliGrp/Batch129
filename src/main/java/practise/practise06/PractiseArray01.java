...
public class PractiseArray01 {
    public static void main(String[] args) {
        ...
        // String bir multidimensional Array oluşturun içerisine data ekleyin
        ...
        int sum =0;// toplam kaç daire olduğu burada
        for (String[] w: brr) {// w=each her bir elemanı getir w=array
           sum = sum+ w.length;
