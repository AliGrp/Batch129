...
public class Bilet {
    ...
    public static void main(String[] args) {
        ...
        if (km>0 && yas>0 &&(yolculukTipi==1||yolculukTipi==2)){
            ...
            System.out.println("Indirimsiz Bilet Ucreti");
    ...
    static void biletDokum(String plakaNumarasi, int km, int yolculukTipi, double biletUcreti, double yasIndirimOrani) {
